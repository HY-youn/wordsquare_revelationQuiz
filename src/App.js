...
const BIBLE_VERSES = {
  revelation: {
    1: {
      ...
      3: "이 예언의 말씀을 읽는 자와 듣는 자들과 그 가운데 기록한 것을 지키는 들이 복이 있나니 때가 가까움이라",
    ...
    4: {
      ...
      7: "첫째 생물은 사자 같고 둘째 생물은 송아지 같고 셋째 생물은 얼굴이 사람 같고 넷째 생물은 날아가는 독수리 같은데",
    ...
    10: {
      ...
      2: "그 손에 펴진 작은 책을 들고 그 오른발은 바다를 밟고 왼발은 땅을 밟고",
      3: "사자의 부르짖는 것같이 큰 소리로 외치니 외칠 때에 일곱 우뢰가 그 소리를 발하더라",
      4: "일곱 우뢰가 발할 때에 내가 기록하려고 하다가 들으니 하늘에서 소리가 나서 말하기를 일곱 우뢰가 발한 것을 인봉하고 기록하지 말라 하더라",
